...
# https://github.com/ajalt/python-sha1#readme
# To use this program, type the text below in the terminal:
# python python_sha1.py file-to-be-hashed.txt
# file-to-be-hashed.txt will be used by this program to hash text.
